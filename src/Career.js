import { Card, Grid, Text, Link, css } from "@nextui-org/react";
      ...
      <Card css={cardcss}>
        <Card.Header>
          ...
          <Grid.Container css={{ pl: "$3" }}>
            <Grid xs={12}>
              <Text h4 css={{ lineHeight: "$xs", marginBottom: "$0", marginTop: "$0" }}>
                SASTRA University
              </Text>
            </Grid>
            <Grid xs={12}>
            ...
            <Grid xs={12}>
              <Text css={{ color: "$accents8", marginTop: "$1", fontSize: '13px' }}>
                <i>June 2017 - June 2021, <b>CGPA: 8.8/10</b></i>
              </Text>
            </Grid>
          </Grid.Container>
        </Card.Header>
      ...
      <Card css={cardcss4}>
        <Card.Header>
          ...
          <Grid.Container css={{ pl: "$3" }}>
            ...
            <Grid xs={12}>
              <Text css={{ color: "$accents8", marginTop: "$1", fontSize: '13px' }}>
                <i>Aug 2022 - Present, <b>CGPA: 3.9/4.0</b></i>
              </Text>
            </Grid>
          </Grid.Container>
        </Card.Header>
